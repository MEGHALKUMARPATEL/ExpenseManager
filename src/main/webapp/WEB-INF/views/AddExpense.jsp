...
<title>ExpenseManager | Add Expense</title>
</head>
<body>
...
<title>Expense Manager | NewExpense</title>
...
<%
	...
	<main id="main" class="main">
		...
		<div class="pagetitle">
	         <a href="admindashboard"><h1>Expense</h1></a>

			<nav>
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="listexpense.jsp">NewExpense</a></li>
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                 ...
                 <!--  <form class="row g-3 needs-validation" novalidate action="saveexpense" method="post">
                  ...
                  <form role="form" action="saveexpense" method="post">
										<div class="mb-3">
										 ...
										 <option value="none" selected disabled hidden>Select SubCategory</option>
											<% for(SubCategoryBean sb:subCategoryList){ %>
													<option value="<%=sb.getSubCategoryId()%>"><%=sb.getSubCategoryName() %></option>
													<%} %>	
													</select>	
										...
										<select name="accountTypeId" class="form-control form-control-lg">
											 <option value="none" selected disabled hidden>Select AccountType</option>
												<% 
													for(AccountTypeBean ab:accountTypeList){ %>
														<option value="<%=ab.getAccountTypeId()%>"><%=ab.getAccountTypeName() %></option>
														<%} %>	
										...
										<div class="text-center">
											<button type="submit"
												class="btn btn-lg btn-primary btn-lg w-100 mt-4 mb-0">Add New Expense</button>
