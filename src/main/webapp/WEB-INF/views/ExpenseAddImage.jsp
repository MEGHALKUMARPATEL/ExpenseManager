...
<title> Expense Manager | Add Image</title>
			...
			<div class="col-lg-12">
				...
				<div class="card">
					<div class="card-body">
						...
						<form action="addexpenseimg" method="post" enctype="multipart/form-data">
							<input type="hidden" name="expenseId" value="${expenseBean.expenseId }"/>
							<input type="file" name="expenseImg" class="form-control">
							

							<div class="row mb-3">
								<div class="col-2"></div>
								<div class="col-2">
									<button class="btn btn-primary w-100" type="submit">Update Expense
									</button>
